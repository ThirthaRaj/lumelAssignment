...
var FileUploadController = /** @class */ (function () {
     ...
     * @param file
     */
    FileUploadController.prototype.uploadFile = function (file) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.fileUploadService.importOrderDetails(file)];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
                        error_1 = _a.sent();
                        common_1.Logger.error('Error in importing orders');
        ...
        (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('file', {
            storage: (0, multer_1.diskStorage)({
                ...
                filename: function (req, file, callback) {
                    ...
                    callback(null, "".concat(name, "-").concat(Date.now()).concat(fileExtName));
                }
            })
        })),
        __param(0, (0, common_1.UploadedFile)(new common_1.ParseFilePipe({
            validators: [
                new common_1.FileTypeValidator({ fileType: 'csv' }),
            ]
        })))
